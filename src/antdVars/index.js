...
function modifyVars(color, obj = {}) {
  ...
  return {
    ...
    '@y-color-brand-1': palettes[0],
    '@y-color-brand-2': palettes[1],
    '@y-color-brand-3': palettes[2],
    '@y-color-brand-4': palettes[3],
    '@y-color-brand-5': palettes[4],
    '@y-color-brand-6': palettes[5],
    '@y-color-brand-7': palettes[6],
    '@y-color-brand-8': palettes[7],
    '@y-color-brand-9': palettes[8],
    '@y-color-brand-10': palettes[9],
